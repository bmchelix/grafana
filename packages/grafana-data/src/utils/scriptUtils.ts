...
const SCRIPT_RANGES: Array<{ script: Script; start: number; end: number }> = [
  ...
  { script: 'latinEx', start: 0x0080, end: 0x00ff }, // Latin Extended
  ...
  { script: 'japanese', start: 0x3040, end: 0x30ff }, // CJK Unified Ideographs (Chinese)
  { script: 'chinese', start: 0x4e00, end: 0x9fff }, // Hiragana/Katakana (Japanese)
