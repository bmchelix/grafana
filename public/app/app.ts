...
// BMC Change: Patch global Emotion cache for RTL BEFORE any React components load
import { patchGlobalEmotionCache } from './core/rtl/patchEmotionCache';
patchGlobalEmotionCache();
