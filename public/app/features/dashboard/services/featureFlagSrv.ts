...
export const FEATURE_CONST = {
  ...
  OPEN_DASHBOARD_WITH_EMPTY_PANELS: 'Open dashboard with empty panels',
  // devops feature flag to show 2 toggles in tenant settings
  BHD_GF_USE_DEFAULT_VARS: 'bhd_gf_use_default_vars',
