      ...
      >
        <div
          style={{
            width: width,
            height: '100%',
            // BMC Change: Keep grid layout in LTR mode so react-grid-layout works normally
            direction: 'ltr',
          }}
...
const GrafanaGridItem = React.forwardRef<HTMLDivElement, GrafanaGridItemProps>((props, ref) => {
  ...
  const { gridWidth, gridPos, isViewing, windowHeight, windowWidth, rtlActive, ...divProps } = props;
