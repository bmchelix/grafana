...
export const getDynamicFieldsFormatterTransformRegistryItem: () => TransformerRegistryItem<DynamicFieldsFormatterTransformerOptions> =
  () => ({
    ...
    name: t('bmc.grafana-data.transformers.dynamic-fields-formatter.name', 'Dynamic Fields Formatter'),
    categories: new Set([TransformerCategory.Reformat]),
    description: t(
      'bmc.grafana-data.transformers.dynamic-fields-formatter.description',
      'Format dynamic fields to key-value pairs or json.'
    ),
    imageDark: darkImage,
