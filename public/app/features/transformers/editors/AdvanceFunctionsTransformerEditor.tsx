...
import { AdvFuncList, AdvFuncTransformerOptions } from '@grafana/data/internal';
import { t, Trans } from '@grafana/i18n';
import { Input, RadioButtonGroup, Select } from '@grafana/ui';
import appEvents from 'app/core/app_events';

import darkImage from '../images/dark/advanceFunctions.svg';
import lightImage from '../images/light/advanceFunctions.svg';
      ...
      <div>
        <div className="gf-form-inline">
          <div className="gf-form">
            <div className="gf-form-label width-8">
              <Trans i18nKey="bmc.transformers.adv-functions.function-name">Function name</Trans>
            </div>
            <Select
              menuShouldPortal
              className="width-18"
        ...
        <div className="gf-form-inline">
          <div className="gf-form gf-form--grow">
            <div className="gf-form-label width-8">
              <Trans i18nKey="bmc.transformers.adv-functions.field-name">Field name</Trans>
            </div>
            <Select
              menuShouldPortal
              className="width-18"
        ...
        {this.showAgainstField() && (
          <div className="gf-form-inline">
            <div className="gf-form gf-form--grow">
              <div className="gf-form-label width-8">
                <Trans i18nKey="bmc.transformers.adv-functions.against-field">Against field name</Trans>
              </div>
              <Select
                menuShouldPortal
                className="width-18"
        ...
        {functionName === AdvFuncList.DeltaFromLastN && (
          <>
            <div className="gf-form-inline">
              <div className="gf-form gf-form--grow">
                <div className="gf-form-label width-8">
                  <Trans i18nKey="bmc.transformers.adv-functions.previous-row">Previous row</Trans>
                </div>
                <Input
                  className="width-18"
                  type="number"
                  value={options.numberOfPrevRows ?? 1}
                  placeholder={t('bmc.transformers.adv-functions.previous-row-placeholder', 'Previous row')}
            ...
            <div className="gf-form-inline">
              <div className="gf-form gf-form--grow">
                <div className="gf-form-label width-8">
                  <Trans i18nKey="bmc.transformers.adv-functions.percentage">Percentage</Trans>
                </div>
                <RadioButtonGroup
        ...
        {functionName === AdvFuncList.Percentile && (
          <>
            <div className="gf-form-inline">
              <div className="gf-form gf-form--grow">
                <div className="gf-form-label width-8">
                  <Trans i18nKey="bmc.transformers.adv-functions.percentile-value">Percentile value</Trans>
                </div>
        ...
        {functionName === AdvFuncList.TopNRank && (
          <>
            <div className="gf-form-inline">
              <div className="gf-form gf-form--grow">
                <div className="gf-form-label width-8">
                  <Trans i18nKey="bmc.transformers.adv-functions.rank-value">Rank value</Trans>
                </div>
                <Input
                  className="width-18"
                  type="number"
                  value={options.rank ?? 0}
                  placeholder={t('bmc.transformers.adv-functions.rank-placeholder', 'Rank')}
            ...
            <div className="gf-form-inline">
              <div className="gf-form gf-form--grow">
                <div className="gf-form-label width-8">
                  <Trans i18nKey="bmc.transformers.adv-functions.alias">Alias</Trans>
                </div>
                <Input
                  className="width-18"
                  type="input"
...
export const getAdvanceFunctionsTransformRegistryItem: () => TransformerRegistryItem<AdvFuncTransformerOptions> =
  () => ({
    ...
    name: t('bmc.grafana-data.transformers.advance-functions.name', 'Advanced functions'),
    description: t(
      'bmc.grafana-data.transformers.advance-functions.description',
...
const PercentileInput: React.FC<{ val: number; onBlur: any }> = (props) => {
  ...
  return (
    <Input
      className="width-18"
      type="number"
      placeholder={t('bmc.transformers.adv-functions.percentile-placeholder', 'percentile value')}
      value={value}
      min={1}
      max={99}
      onBlur={props.onBlur}
