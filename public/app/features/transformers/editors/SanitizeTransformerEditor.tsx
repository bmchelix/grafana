...
export const getSanitizeFieldTransformRegistryItem: () => TransformerRegistryItem<SanitizeFieldTransformerOptions> =
  () => ({
    ...
    name: t('bmc.grafana-data.transformers.sanitize-fields.name', 'Sanitize fields'),
    description: t('bmc.grafana-data.transformers.sanitize-fields.description', 'Sanitize a field to plain text'),
    imageDark: darkImage,
