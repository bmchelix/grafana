...
import { getTextDirection, overrideDir } from '@grafana/ui/internal';
...
export function DashboardsTree({
  ...
  return (
    ...
    <div {...getTableProps()} {...overrideDir()} role="table">
      ...
      <div {...getTableBodyProps()} {...overrideDir()} data-testid={selectors.pages.BrowseDashboards.table.body}>
        <InfiniteLoader
