...
import { ENGLISH_US, LANGUAGES } from 'app/core/internationalization/constants';
import { GrafanaRouteComponentProps } from 'app/core/navigation/types';

import { LocaleKeyManagement } from './LocaleKeyManagement';
import { DashboardLocale, initializeGlobalLocale, syncLocaleKeys } from './types';
...
export const GlobalLocales: FC<GrafanaRouteComponentProps> = memo(() => {
  ...
  const handleExport = useCallback(() => {
    try {
      const syncedLocales = syncLocaleKeys(locales, ENGLISH_US).locales;
      const dataStr = JSON.stringify(syncedLocales);
