...
export function getPermissionsGroup(groupName: string) {
  switch (groupName) {
    ...
    case 'HelixGPT Insight Finder':
      return t('bmc.rbac.permissions.insightfinder.title', 'HelixGPT Insight Finder');
    default:
      return 'NA';
  }
}
...
export function getPermissionsDesc(name: string) {
  switch (name) {
    ...
    case 'insightfinder:access':
      return t('bmc.rbac.permissions.insightfinder.access-desc', 'can access insight finder');
    case 'insightfinder.dashboards:create':
      return t('bmc.rbac.permissions.insightfinder.dashboards-create-desc', 'can create dashboards through insight finder');
    case 'reports.dynamic.recipients:access':
      return t('bmc.rbac.permissions.reports.recipients-dash-access-desc', 'Can add recipients dynamically from dashboard in schedule');
    default:
      return 'NA';
  }
}
