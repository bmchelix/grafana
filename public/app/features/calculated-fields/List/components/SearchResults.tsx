...
import { CalcFieldItem, CalcFieldModule, OnToggleChecked, SearchLayout } from '../../types';
import { filterByQuery, filterByType, sortListResults, sortSectionResults } from '../../utils';
    ...
    return items.length ? (
      <div className={styles.listModeWrapper}>
        <AutoSizer disableWidth>
          {({ height }) => (
            <FixedSizeList
              aria-label={t('bmc.calc-fields.search-items', 'Search items')}
