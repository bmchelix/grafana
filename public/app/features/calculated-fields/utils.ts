...
import { DEFAULT_CALC_FIELD, getDefaultSort, SESSION_DS_INS_URL_KEY } from './constants';
import { CalcFieldItem, CalcFieldModule, CalcFields, FormColumn, SearchLayout, SearchQuery } from './types';
...
export const sortSectionResults = (results: CalcFieldModule[], sortOrder: SelectableValue): CalcFieldModule[] => {
  switch (sortOrder ? sortOrder.value : getDefaultSort().value) {
    case 'alpha-asc': {
