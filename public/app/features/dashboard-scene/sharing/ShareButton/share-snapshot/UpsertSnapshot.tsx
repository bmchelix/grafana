...
import { Alert, Divider, Field, Input, RadioButtonGroup, Stack, Text, useStyles2 } from '@grafana/ui';
          ...
          <Text>
            {panelRef ? (
              ...
              <Trans i18nKey="snapshot.share-panel.info-alert">
                A panel snapshot publicly shares a panel while removing sensitive data such as queries and panel links,
                leaving only visible metrics and series names. Anyone with the link can access the snapshot.
              </Trans>
            ) : (
              // BMC code: remove "Grafana" from the text
              <Trans i18nKey="snapshot.share.info-alert">
                A dashboard snapshot publicly shares a dashboard while removing sensitive data such as queries and panel
