...
} from './new-toolbar/actions/ForceRtlPreviewToggle';
...
export function ToolbarActions({ dashboard }: Props) {
  ...
  // BMC Change: Arabic Editor/Admin RTL preview (legacy ToolbarActions path when dashboardNewLayouts is off); same rules as RightActions + ForceRtlPreviewToggle.
  toolbarActions.push({
    group: 'main-buttons',
    condition:
    ...
    render: () => <ForceRtlPreviewToggle key="force-rtl-preview" dashboard={dashboard} />,
  });
