...
export const DashboardPicker = forwardRef<HTMLElement, Props>(
  ({ value, onChange, placeholder = t('bmcgrafana.dashboard.picker.placeholder','Select dashboard'), noOptionsMessage = t('bmcgrafana.dashboard.picker.no-options-message','No dashboards found'), ...props }, ref) => {
