...
export function getNavTitle(navId: string | undefined) {
  ...
  switch (navId) {
    ...
    case 'recently-deleted':
      return t('bmc.recently-deleted.title', 'Deleted dashboard archive');
    // BMC code - end
    case 'reports':
    ...
    case 'insight-finder/custom-data-integrator':
      return t('bmc.nav.apps.insight-finder.custom-data-integrator-title', 'Custom Data Integrator');
    // BMC Code: End
    case 'plugins':
...
export function getNavSubTitle(navId: string | undefined) {
  switch (navId) {
    ...
    case 'recently-deleted':
      return t('nav.bmc-recently-deleted.subtitle', 'View recently deleted dashboards and restore them to its original folder');
    // BMC code - end
    case 'dashboards/recently-deleted':
      return t(
    ...
    case 'cfg/general':
      return t(
        'bmcgrafana.nav.config-general.subtitle',
        'Manage default preferences and settings across BMC Helix Dashboards'
      );
    case 'cfg/plugins':
    ...
    case 'insight-finder/custom-data-integrator':
      return t('bmc.nav.apps.insight-finder.custom-data-integrator-subtitle', 'View and customize your views');
    //BMC Code: End
    case 'apps':
