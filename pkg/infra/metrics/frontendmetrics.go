...
func initFrontendMetrics(r prometheus.Registerer) {
	...
	*/
	...
	registerFrontendCounterVec(r, "api_insightfinder_value_realization_prompt_count", []string{"tenant_id", "user_id", "datasource_id", "agent_id", "response_class"}, "Insightfinder value realization prompt count")
	registerFrontendCounterVec(r, "api_insightfinder_value_realization_conversation_count", []string{"tenant_id", "user_id", "datasource_id", "agent_id", "response_class"}, "Insightfinder value realization conversation count")
	registerFrontendCounterVec(r, "api_insightfinder_value_realization_panels_generated_count", []string{"tenant_id", "user_id", "datasource_id", "agent_id", "response_class"}, "Insightfinder value realization panels generated count")
	registerFrontendHistogramVec(r, "api_insightfinder_value_realization_response_time_ms", []string{"tenant_id", "user_id", "datasource_id", "agent_id", "response_class"}, "Insightfinder value realization response time")
