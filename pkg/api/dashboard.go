...
func (hs *HTTPServer) SoftDeleteDashboard(c *contextmodel.ReqContext) response.Response {
	...
	if err != nil {
		...
		// BMC CODE STARTS
		go audit.DashboardSoftDeleteAudit(c, err, dash)
		// BMC CODE ENDS
	...
	// BMC CODE STARTS
	go audit.DashboardSoftDeleteAudit(c, nil, dash)
	// BMC CODE ENDS
...
func (hs *HTTPServer) deleteDashboard(c *contextmodel.ReqContext) response.Response {
	...
	if err != nil {
		...
		// BMC CODE STARTS
		go audit.DashboardDeleteAudit(c, err, dash)
		// BMC CODE ENDS
	...
	// BMC CODE STARTS
	go audit.DashboardDeleteAudit(c, nil, dash)
	// BMC CODE ENDS
