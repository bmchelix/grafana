...
func (hs *HTTPServer) registerRoutes() {
	...
	r.Get("/admin/provisioning/*", reqOrgAdmin, hs.Index) 
    r.Get("/dashboards/bhd-recently-deleted", reqOrgAdmin, hs.Index)
	...
	r.Group("/api", func(apiRoute routing.RouteRegister) {
		...
		// Helix Code start: Restore Deleted Dashboard API
		apiRoute.Group("/bhd-recently-deleted", func(bhdTrash routing.RouteRegister) {
			bhdTrash.Get("", reqSignedIn, reqOrgAdmin, routing.Wrap(hs.ListArchiveDashboards))
			bhdTrash.Post("/:id/restore", reqSignedIn, reqOrgAdmin, routing.Wrap(hs.RestoreArchiveDashboard))
		})
		// Helix Code end
