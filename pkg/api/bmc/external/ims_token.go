...
func getIMSToken(req *http.Request, tenantId, userId int64) (string, error) {
	...
	impersonationToken, err := GenerateUserJWTUsingServiceAccount(tenantId, userId)
	if err != nil {
		return "", err
	}
...
func GenerateUserJWTUsingServiceAccount(tenantId int64, userId int64) (string, error) {
