...
var (
	...
	SupportedLanguages      = []Locale{LocaleENUS, LocaleFRFR, LocaleDEDE, LocaleESES, LocaleENCA, LocaleFRCA, LocaleITIT, LocaleARAR, LocalePTBR, LocaleRURU, LocaleZHHANS, LocaleJAJP, LocaleKOKR, LocaleCAES, LocalePLPL}
)
