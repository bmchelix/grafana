...
func insertQueryForInsightFinderPermission() string {
	var newPermissions = []BhdRolePermission{
		{"HelixGPT Insight Finder", "insightfinder:access", "Access", "can access insight finder", false},
		{"HelixGPT Insight Finder", "insightfinder.dashboards:create", "Create dashboards", "can create dashboards through insight finder", false},
	}
