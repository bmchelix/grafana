...
func AddRolePermissionRbacTable(mg *mig.Migrator) {
	...
	var newInsightFinderPermissions = []BhdRolePermission{
		{"HelixGPT Insight Finder", "insightfinder:access", "Access", "can access insight finder", true},
		{"HelixGPT Insight Finder", "insightfinder.dashboards:create", "Create dashboards", "can create dashboards through insight finder", true},
	}
