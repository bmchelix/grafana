...
func AddMigration(mg *mig.Migrator) {
	...
	mg.AddMigration("bhd: add column ca_ES in bhd_localization table", mig.NewAddColumnMigration(localizationTableV1, &mig.Column{
		Name: "ca-ES", Type: mig.DB_Text, Nullable: false, Default: "'{}'",
	}))
	mg.AddMigration("bhd: add column pl_PL in bhd_localization table", mig.NewAddColumnMigration(localizationTableV1, &mig.Column{
		Name: "pl-PL", Type: mig.DB_Text, Nullable: false, Default: "'{}'",
	}))
}
