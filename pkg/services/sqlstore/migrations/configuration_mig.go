...
const (
	defaultOrg           = 1
	defaultDocLink       = "https://docs.helixops.ai/bin/Helix-Common-Services/Dashboards-Reports/BMC-Helix-Dashboards/BHD263/"
...
func addCustomConfigurationMigrations(mg *Migrator) {
	...
	mg.AddMigration("Updating configuration for documentation link, 26.3.00 release",
		NewRawSQLMigration(fmt.Sprintf(`
			UPDATE configuration SET doc_link='%s' where org_id=1`, defaultDocLink)),
	)
}
