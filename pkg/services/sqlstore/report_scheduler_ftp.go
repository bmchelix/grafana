...
func (ss *SQLStore) GetFTPConfig(ctx context.Context, query *models.GetFTPConfig, includePassword bool) error {
	return ss.WithDbSession(ctx, func(dbSession *DBSession) error {
		...
		if query.OrgId != 0 {
			sess = sess.Where("report_ftp_config.org_id = ?", query.OrgId)
		}
