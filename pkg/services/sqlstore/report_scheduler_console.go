...
func (ss *SQLStore) GetReportListJobQueue(ctx context.Context, query *models.GetReportListJobQueue) error {
	...
	return ss.WithDbSession(ctx, func(dbSession *DBSession) error {
		...
		t.count_runs, f.count_fail,COALESCE(j.description, s.description) as last_fail, j.file_key, j.deleted,COALESCE(j.value,s.value), dj.dynamic_recipients, r.is_dynamic_bcc_recipients,
