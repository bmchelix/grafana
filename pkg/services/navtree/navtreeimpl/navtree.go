...
func (s *ServiceImpl) buildDashboardNavLinks(c *contextmodel.ReqContext) []*navtree.NavLink {
	...
	if c.OrgRole == org.RoleAdmin {
		dashboardChildNavs = append(dashboardChildNavs, &navtree.NavLink{
			Text:    "Deleted Dashboard Archive",
			Id: 	 "recently-deleted",
			Url:      setting.AppSubUrl + "/dashboards/bhd-recently-deleted",
			Icon:     "trash-alt",
			SubTitle: "View and restore recently deleted dashboards",
		})
	}
	// End
