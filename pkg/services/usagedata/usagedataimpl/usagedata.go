...
func (s *Service) GetUserData(ctx context.Context, orgId int64, loginId string, status string) (usagedata.UserCountResponse, error) {
	return s.store.GetUserDataService(ctx, orgId, loginId, status)
}
...
func (s *Service) GetDashboardHitsUserInfo(ctx context.Context, fromTime string, toTime string, orgID int64, user string, dashboard string) (usagedata.DashboardHitCountWithUserInfoResponse, error) {
