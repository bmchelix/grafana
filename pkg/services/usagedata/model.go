...
type DashboardHitCountWithUserInfo struct {
	Id            int64   `xorm:"id"`
...
type DashboardHitCountWithUserInfoResponse struct {
	Data []DashboardHitCountWithUserInfo
}

func (d DashboardHitCountWithUserInfoResponse) Len() int {
	return len(d.Data)
}
