...
# administration/metricserver, jobs/init-db, source-plugins/bmc-csv-datasource, source-plugins/bmchelix-servicenow-datasource
ARG GO_IMAGE=aus-harborpd-01.bmc.com/helix-cloudops/adereporting-base-golang:1.25.12-alpine
...
#
RUN git config --system url."https://${ADEREPORTING_GITHUB_USER}:${ADEREPORTING_GITHUB_TOKEN}@github.com/DSOM-ADE/".insteadOf "https://github.com/DSOM-ADE/"
...
RUN go env -w GOPRIVATE='github.com/DSOM-ADE/*'
RUN git config --system url."https://${ADEREPORTING_GITHUB_USER}:${ADEREPORTING_GITHUB_TOKEN}@github.com/DSOM-ADE/".insteadOf "https://github.com/DSOM-ADE/"
