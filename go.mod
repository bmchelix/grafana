...
// Helix code changes start
replace github.bmc.com/DSOM-ADE/authz-go => github.com/DSOM-ADE/authz-go v0.0.0-20250508114922-e36638bfaa5e

// Helix code changes end
